...
public class HomeScreen implements Screen {
    ...
    public void show() {
        ...
        newGameButton.setPosition(1079-218,500);
        loadGameButton.setPosition(1079-218, 400);
        quitGameButton.setPosition(1079-218, 300);
    ...
    public void render(float delta) {
        ...
        batch.draw(logoTexture, 1079-520, 600, 800, 400);
        batch.end();
