...
public class LevelThree extends Level {
    ...
    public LevelThree(Main game, HashMap<String, Screen> levelScreens) {
    ...
    public LevelThree(Main game, LevelState levelState, HashMap<String, Screen> levelScreens) {
        super(game, levelScreens, new World(new Vector2(0, -8f), true));
        this.currentLevel = "LevelThree";
        initializeLevel();
    ...
    private void initializeEntities() {
        ...
        birds.add(new BlackBird(game.getAssetManager().get("images/black_bird.png", Texture.class), BlackBird.id, 20 / 10f, (1079 - 820) / 10f, 95 / 10f, 90 / 10f, 1.7f, (125 / 2) / 10f, 10, world));
        birds.add(new RedBird(game.getAssetManager().get("images/red_bird.png", Texture.class), RedBird.id, 260 / 10f, (1079 - 820) / 10f, 75 / 10f, 75 / 10f, 3.9f, (80 / 2) / 10f, 6, world));


        // Pigs remain unchanged as array
        pigs = new ArrayList<>();
        pigs.add(new SmallPig(game.getAssetManager().get("images/small_pig.png", Texture.class), SmallPig.id,1250 / 10f, (1079 - 925+25) / 10f, 160 / 10f, 110 / 10f, 1f, (120/ 2) / 10f,6, world));
        pigs.add(new SmallPig(game.getAssetManager().get("images/small_pig.png", Texture.class), SmallPig.id,1665 / 10f, (1079 - 925+25) / 10f, 160 / 10f, 110 / 10f, 1f, (120/ 2) / 10f,6, world));
        pigs.add(new KingPig(game.getAssetManager().get("images/king_pig.png", Texture.class), KingPig.id,1250 / 10f, (1079 - 925 + 38 + 235+45) / 10f, 135 / 10f, 120 / 10f, 2f, (230 / 2) / 10f, 15,world));
        pigs.add(new KingPig(game.getAssetManager().get("images/king_pig.png", Texture.class), KingPig.id,1665 / 10f, (1079 - 925 + 38 + 235+45) / 10f, 135 / 10f, 120 / 10f, 2f, (230 / 2) / 10f, 15,world));
        pigs.add(new SmallPig(game.getAssetManager().get("images/small_pig.png", Texture.class), SmallPig.id,1250 / 10f, (1079 - 925 + 38 + 235+35+190) / 10f, 160 / 10f, 110 / 10f, 1f, (120/ 2) / 10f,6, world));
        pigs.add(new SmallPig(game.getAssetManager().get("images/small_pig.png", Texture.class), SmallPig.id,1665 / 10f, (1079 - 925 + 38 + 235+35+190) / 10f, 160 / 10f, 110 / 10f, 1f, (120/ 2) / 10f,6, world));
        pigs.add(new BigPig(game.getAssetManager().get("images/big_pig.png", Texture.class), BigPig.id,1450 / 10f, (1079 - 925 + 38 + 235+35+150+190+27) / 10f, 125 / 10f, 100 / 10f, 2.5f, (190 / 2) / 10f, 11,world));


        blocks = new ArrayList<>();
        blocks.add(new StoneBlock(new Texture(Gdx.files.internal("images/st_stoneblock.png")), StoneBlock.id,1150 / 10f, (1079 - 925+25) / 10f, 60 / 10f, 250 / 10f, 1f, 3,world));
        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id, 1350 / 10f, (1079 - 925+20) / 10f, 60 / 10f, 250 / 10f, 3f,10, world));
        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id, 1550 / 10f, (1079 - 925+20) / 10f, 60 / 10f, 250 / 10f, 3f,10, world));
        blocks.add(new StoneBlock(new Texture(Gdx.files.internal("images/st_stoneblock.png")), StoneBlock.id, 1750 / 10f, (1079 - 925+20) / 10f, 60 / 10f, 250 / 10f, 1f, 12,world));
        blocks.add(new GlassBlock(new Texture(Gdx.files.internal("images/sp_glassblock.png")), GlassBlock.id, 1240 / 10f, (1079 - 925 + 38 + 225 ) / 10f, 330 / 10f, 40 / 10f, 1f, 7,world));
        blocks.add(new GlassBlock(new Texture(Gdx.files.internal("images/sp_glassblock.png")), GlassBlock.id, 1650 / 10f, (1079 - 925 + 38 + 225) / 10f, 330 / 10f, 40 / 10f, 1f, 7,world));



        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1150 / 10f, (1079 - 925 + 38 + 235+35) / 10f, 50 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)
        blocks.add(new GlassBlock(new Texture(Gdx.files.internal("images/sp_glassblock.png")), GlassBlock.id , 1250 / 10f, (1079 - 925 + 38 + 235+35+150) / 10f, 330 / 10f, 40 / 10f, 2f, 7,world));//bottom to up (bottom left)
        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1350 / 10f, (1079 - 925 + 38 + 235+40) / 10f, 50 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)


        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1150 / 10f, (1079 - 925 + 38 + 235+35+150+40) / 10f, 40 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)
        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1350 / 10f, (1079 - 925 + 38 + 235+35+190) / 10f, 40 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)


        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/stone_blocks.png")), WoodBlock.id , 1450 / 10f, (1079 - 925 + 38 + 235+35+150+190) / 10f, 680 / 10f, 25 / 10f, 2f, 12,world));//bottom to up (bottom left)

        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1550 / 10f, (1079 - 925 + 38 + 235+35) / 10f, 50 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)
        blocks.add(new GlassBlock(new Texture(Gdx.files.internal("images/sp_glassblock.png")), GlassBlock.id , 1650 / 10f, (1079 - 925 + 38 + 235+35+150) / 10f, 330 / 10f, 40 / 10f, 2f, 7,world));//bottom to up (bottom left)
        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1750 / 10f, (1079 - 925 + 38 + 235+40) / 10f, 50 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)


        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1550 / 10f, (1079 - 925 + 38 + 235+35+150+40) / 10f, 40 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)
        blocks.add(new WoodBlock(new Texture(Gdx.files.internal("images/standing_woodblock.png")), WoodBlock.id , 1750 / 10f, (1079 - 925 + 38 + 235+35+190) / 10f, 40 / 10f, 150 / 10f, 2f, 10,world));//bottom to up (bottom left)
